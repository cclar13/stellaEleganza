...
var optionsBar = {
  ...
  series: [{
    name: "Masculino",
    data: [10, 23, 6, 23, 23, 12, 22],
  }, {
    name: "Feminino",
    data: [10, 17, 23, 25, 19, 25, 34],
  }],
  labels: ['05/05/2024','06/05/2024','07/05/2024','08/05/2024','09/05/2024','10/05/2024','11/05/2024'],
  xaxis: {
    labels: {
      show: false
    },
...
var optionDonut = {
  ...
  series: [21, 23, 26, 50, 28, 33],
  labels: ['Blazers masculino', 'Blazers feminino', 'Camisas', 'Blusas', 'Calças femininas','Calças masculinas'],
  legend: {
    position: 'left',
    offsetY: 80
  }
